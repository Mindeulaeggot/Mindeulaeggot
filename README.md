...
[scm-demand-forecast-inventory-optimization](https://github.com/Mindeulaeggot/scm-demand-forecast-inventory-optimization)
...
- built a churn classification workflow on `64,374` customer records
...
- case-study style writeups for flagship projects
- portfolio review rubric for continuous improvement
- upgrade roadmap for future analytics work
